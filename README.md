...
* [Proof of Passport](https://github.com/zk-passport/proof-of-passport) ⭐ 1,257 | 🐛 34 | 🌐 Circom | 📅 2026-09-06
...
* [Implementation in C](https://github.com/Tongsuo-Project/Tongsuo) ⭐ 1,526 | 🐛 157 | 🌐 C | 📅 2026-09-07
...
* [Zcash Sapling protocol spec](https://github.com/zcash/zips/blob/master/protocol/protocol.pdf) ⭐ 305 | 🐛 325 | 🌐 TeX | 📅 2026-09-08 (very useful as detailed cheat-sheet of all cryptography used)
...
* [gnark - library for zero-knowledge proof protocols written in Go](https://github.com/ConsenSys/gnark) ⭐ 1,732 | 🐛 89 | 🌐 Go | 📅 2026-09-09
...
* [SnarkyJS - a TypeScript framework for writing zk-SNARKs in the browser and developing Snapps for Mina Protocol by O(1) labs - WIP](https://github.com/o1-labs/snarkyjs) ⭐ 606 | 🐛 250 | 🌐 TypeScript | 📅 2026-09-09
